...
$string['formula_max_len'] = 'Formula max. length';
$string['formula_max_len_help'] = 'Formula max. allowed length. Anything below 1 means unlimited.';
$string['formula_allowed_chars'] = 'Allowed characters';
$string['formula_allowed_chars_help'] = 'Allowed characters in formula. Anyting other than (∅ABCU∩∪\\Δ\') is ignored. Leave empty for no limits.';
